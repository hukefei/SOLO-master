...
class SSIMLoss(torch.nn.Module):
    ...
    def forward(self, img1, img2):
        ...
        return self.loss_weight * _ssim(img1, img2, window, self.window_size, channel, self.size_average)
...
@LOSSES.register_module
class LOGSSIMLoss(torch.nn.Module):
    def __init__(self, window_size=11, size_average=True, loss_weight=1.0):
        super(LOGSSIMLoss, self).__init__()
        self.window_size = window_size
        self.size_average = size_average
        self.channel = 1
        self.window = create_window(window_size, self.channel)
    ...
    def forward(self, img1, img2):
        ...
        return self.loss_weight * _logssim(img1, img2, window, self.window_size, channel, self.size_average)

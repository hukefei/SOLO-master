...
from ..backbones.utils import Conv2dStaticSamePadding, MaxPool2dStaticSamePadding, MemoryEfficientSwish, Swish
...
class BiFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.bifpn = nn.Sequential(
            *[SingleBiFPN(num_channels=self.out_channels,
                          conv_channels=self.conv_channel_coef[compound_coef],
